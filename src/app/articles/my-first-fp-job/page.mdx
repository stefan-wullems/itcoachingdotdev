...
<img src="/fplangs.png" className="rounded-3xl bg-gray-950" alt='Functional Programming' />
...
[That sounds pretty cool. Tell me more →](https://www.stefanwullemscoaching.com/webdevrocket)