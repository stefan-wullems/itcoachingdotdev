...
export const article = {
  ...
  date: '2024-03-08',
  title: 'Should you get the AWS Certified Cloud Practitioner certification?',
...
Welcome to Certification Roast. In this series, you’ll follow me as I collect certificates, speculate whether you should bother getting the certification as well, and give recommendations on how to effectively prepare for the certification exams.
...
I’m a Web Career Coach which means that I will be looking at how useful these certificates are to progressing a Web career (this includes the entire stack, from frontend to backend, from deployment to security, from communication to working effectively in a team). 
If you are a Web Engineer of some kind, you might want to read on. The recommendations and insights are custom tailored to you!

## The AWS Certified Cloud Practitioner

The AWS Certified Cloud Practitioner certification focuses on foundational knowledge of AWS. To be a bit more concrete, it goes relatively deep into the core of AWS, the things that you will almost certainly need, or at least want to be aware of when building your AWS architecture.

It covers the basic building blocks like getting code to run in the cloud (EC2, Lambda), storing different kinds of data for different purposes and durations (S3, EBS, EFS and many database solutions), and the mechanisms to communicate securely and reliably between the components of your application (VPC’s, Subnets, ACL’s, Security Groups, SNS, SQS and more).

Next to that you will take a tour of most of the more specialized services that AWS provides. Just enough to be aware they exist, and know when to reach for them if necessary, without drowning you in the details.
...
After I aced the final quiz at end of this course, I went into the exam with misinformed confidence. It didn’t take many questions before I realized I wasn’t as prepared as I thought, and I had to resort to guessing and deducing in order to pass my exam. Not fun…

I explored some other courses on the AWS Skill Builder that can probably supplement the gaps, but there will be some overlap with what you already know, which is a bit of a waste of time, and you might have to sign up for a monthly subscription to the AWS Skill Builder which will cost you $30 a month.

All power to you if that’s what you want to go for. I recommend checking out [AWS Cloud Quest](https://aws.amazon.com/training/digital/aws-cloud-quest/), a gamified way of learning how to use the AWS Management Console. A bit cringe, but also a bit interesting. 

I’d rather recommend a single course that covers everything you need to know from start-to-end though, so let’s continue.
...
Although I personally will be going for Stephane’s courses to study for more advanced certifications, Andrew’s course is a great option.
