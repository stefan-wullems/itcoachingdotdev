export default function PrivacyPolicy() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to itcoaching.dev.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to itcoaching.dev, accessible from{' '}
            <a
              href="https://www.itcoaching.dev"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.itcoaching.dev
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: stefan@itcoaching.dev</li>
      </ul>
    </>
  )
}
